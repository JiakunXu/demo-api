...
public interface ZhimaCreditPayAfterUseCreditBizOrderService {
     ...
     * @return
     */
    AlipayOpenApiGenericResponse order(String outOrderNo, String creditAgreementId,
                                       String categoryId, BigDecimal orderAmount, String subject);
     ...
     * @return
     */
    AlipayOpenApiGenericSDKResponse create(String outOrderNo, BigDecimal orderAmount,
                                           String zmServiceId, String categoryId, String subject);
     ...
     * @return
     */
    AlipayOpenApiGenericResponse query(String creditBizOrderId, String outOrderNo);
     ...
     * @return
     */
    AlipayOpenApiGenericResponse finish(String outRequestNo, String creditBizOrderId,
