...
public interface TransactionsService {
    ...
    String HTTPS_NATIVE_URL = "https://api.mch.weixin.qq.com/v3/pay/partner/transactions/native";
     ...
     * @throws RuntimeException
     */
    String getCodeUrl(Transaction transaction) throws RuntimeException;
