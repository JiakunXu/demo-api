...
import com.example.demo.api.bytedance.TextService;
...
public class TextServiceImpl implements TextService {
    ...
    @Override
    public Log antidirt(String accessToken, Body body) throws RuntimeException {
        ...
        try {
            ...
            log = JSON.parseObject(
                HttpUtil.post(TextService.HTTPS_ANTIDIRT_URL, JSON.toJSONString(body), header),
                Log.class);
        } catch (Exception e) {
